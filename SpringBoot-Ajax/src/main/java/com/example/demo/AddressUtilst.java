 ...
 *
 */
public class AddressUtilst {

    private static final Logger logger = LoggerFactory.getLogger(AddressUtilst.class);
    ...
    public  String getAddresses(String content, String encodingString) throws UnsupportedEncodingException {
        // 这里调用pconline的接口
        String urlStr = "http://ip.taobao.com/service/getIpInfo.php";   // 淘宝的api
//        String urlStr = "http://api.map.baidu.com/location";  //百度API
